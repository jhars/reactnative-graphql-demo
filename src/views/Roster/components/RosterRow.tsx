    ...
    if (playerInfo) {
      return (
        <View
          ...
          testId={"rosterRowDropButtonID"}
        >
          <TouchableOpacity
            style={ButtonStyles.dropButton}
            onPress={() => {
              dropPlayerCallback({
    ...
    <View style={styles.container}>
      ...
      <View style={RowStyles.pointsColumn}>
        <Text style={styles.pointsRowText}>
          {playerInfo?.statistics.statLineLastSeason.points ?? "  "}
        </Text>
      </View>
